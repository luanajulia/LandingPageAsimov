  ...
  return (
    <section className="py-16 md:py-24 grid md:grid-cols-2 gap-12 items-center">
      <div>
        ...
        <p className="text-xl text-gray-700 font-sans mb-10 max-w-xl">
      ...
      <div className="flex justify-center">
        ...
        <div className="bg-brand-light-bg p-8 rounded-3xl w-full max-w-md aspect-square flex items-center justify-center">
